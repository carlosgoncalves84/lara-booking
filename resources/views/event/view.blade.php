    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <p>
                Time:
                <br>
                {{ $event->start_time }} until 4:00pm, 5th Feb 2017
            </p>
            ...
            <form action='/events/. {{$event->name}}' style="display:inline;" method="POST">
                <button class="btn btn-danger" type="submit"><span class="glyphicon glyphicon-trash"></span> Delete</button>
            </form>
            <a class="btn btn-primary" href='/events/. {{$event->name}} ./edit'>
